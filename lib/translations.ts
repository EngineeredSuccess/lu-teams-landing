export const translations = {
    en: {
        ...
        roadmap: {
            ...
            title: "Roadmap",
            highlight: "2026",
            subtitle: "Our commitment to data-driven innovation and user privacy. Follow our journey from core features to full AI independence.",
            items: [
                {
                    quarter: "Q1 2026",
    ...
    pl: {
        ...
        roadmap: {
            badge: "Wizja Przyszłości",
            title: "Mapa Drogowa",
            highlight: "2026",
            subtitle: "Nasze zaangażowanie w innowacje oparte na danych i prywatność użytkowników. Śledź naszą podróż od podstawowych funkcji do pełnej niezależności AI.",
            items: [
                {
                    quarter: "Q1 2026",
                    title: "Monetyzacja i Podstawy",
                    description: "Wprowadzenie Cennika i Funkcji Bezpieczeństwa AI",
                    details: [
                        "Uruchomienie planów Basic, Mid i Enterprise",
                        "Ograniczone działania AI dla bezpieczeństwa",
                        "Dynamiczne rekomendacje",
                        "Narzędzia Enterprise (statyczni agenci, RAG dla własnych danych)",
                        "Zabezpieczenie pierwszych partnerstw enterprise",
                        "Integracja opinii użytkowników"
                    ]
                },
                {
                    quarter: "Q2 2026",
                    title: "Ekspansja i Doradztwo",
                    description: "Doradztwo AI/ML i Integracja Narzędzi",
                    details: [
                        "Uruchomienie usług doradczych AI/ML",
                        "Integracje z Jira, Slack i MS Teams",
                        "Pomiar ROI dla produktywności zespołu",
                        "Publikacja studiów przypadków sukcesu"
                    ]
                },
                {
                    quarter: "Q3 2026",
                    title: "Wzrost i Infrastruktura",
                    description: "Skalowanie Zespołu i Decyzje Sprzętowe",
                    details: [
                        "Zatrudnienie kluczowych talentów w ML i Dev",
                        "Finalizacja wyboru sprzętu i LLM",
                        "Przygotowanie do zaawansowanych wdrożeń on-prem",
                        "Cel: 10-15 aktywnych klientów enterprise",
                        "Skupienie na sektorach o wysokich wymaganiach"
                    ]
                },
                {
                    quarter: "Q4 2026",
                    title: "Niezależność i Zaawansowane",
                    description: "Lokalne LLM i Globalna Produkcja",
                    details: [
                        "Wdrożenie lokalnego/on-prem LLM (oparte na Mistral)",
                        "Wprowadzenie systemów wieloagentowych",
                        "Integracje z pakietami biurowymi",
                        "Niestandardowe dostrajanie (fine-tuning) dla enterprise",
                        "Pełna globalna dostępność produkcyjna"
                    ]
                }
            ],
            details: "Szczegóły",
